  ...
  window.SACPortalExtras = {
    ...
    GLOSSARY: {
      ...
      2: [
        ...
        { term: "Optimized Story", meaning: "Modern story runtime — always use for new dashboards." }
      ],
      3: [
        ...
        { term: "Data Wrangler", meaning: "Transform tool during import — fix dates, split columns, drop blanks." },
      ...
      4: [
        ...
        { term: "Geo enrichment", meaning: "Maps dimension members (South, West) to geographic coordinates." },
      ...
      5: [
        ...
        { term: "Builder panel", meaning: "Right panel — chart type, Rows, Columns, Measures assignment." },
      ...
      6: [
        ...
        { term: "Search to Insight", meaning: "Type a question in natural language — SAC builds an answer chart." },
      ...
      2: [
        {
          ...
          steps: [
            ...
            { action: "Open Stories menu", menu: "Home → Stories", detail: "Browse sample content. Open BestRunJuice or similar sample story if present — note chart types and filters." },
            { action: "Open Models menu", menu: "Home → Models", detail: "Open a sample model. Identify dimensions (Region, Product) vs measures (Revenue)." },
            { action: "Locate start pages", menu: "Home → Stories · Modeler", detail: "Each app has browse + create on one page — Modeler on Day 3, Stories on Day 5." },
            { action: "Open Files and Connections", menu: "Home → Files · Connections", detail: "Files = uploaded CSVs. Connections = live or import sources. RetailCo CSV lands in Files on Day 3." }
          ],
        ...
        },
        {
          ...
          steps: [
            { action: "Create a new story", menu: "Create → Story → Optimized Story", detail: "Select an existing model (sample or blank with sample data)." },
      ...
      3: [
        {
          ...
          steps: [
            ...
            { action: "Start model from file", menu: "Create → Model → Get data from a file", detail: "Select your uploaded CSV." },
            { action: "Run Data Wrangler if needed", menu: "Import wizard → Data Wrangler", detail: "Fix date format to consistent DD/MM/YYYY or YYYY-MM-DD. Remove blank rows. Trim Region text." },
      ...
      4: [
        {
          ...
          steps: [
            ...
            { action: "Enable geo enrichment", menu: "Modeler → Region dimension → Location Information", detail: "Enable enrichment, set location type for Indian states/regions. Verify map widget shows India regions." },
      ...
      5: [
        {
          ...
          steps: [
            { action: "Create Optimized Story", menu: "Create → Story → Optimized Story", detail: "Select model RetailCo_Sales_Analytic. Add Canvas page — name it Executive Summary." },
      ...
      7: [
        {
          ...
          steps: [
            { action: "Create Planning Model", menu: "Create → Model → Planning Model", detail: "Not Analytic Model. Add dimensions: Account, Region, Product Category, Time, Version." },
            ...
            { action: "Create planning story with data entry table", menu: "Create → Story → add Table widget", detail: "Bind to RetailCo_Planning. Rows = accounts/regions, columns = months, version = Budget." },
      ...
      8: [
        {
          ...
          steps: [
            { action: "Open Data Actions", menu: "Main menu → Planning → Data Actions", detail: "Create new Data Action on RetailCo_Planning." },
      ...
      10: [
        {
          ...
          steps: [
            ...
            { action: "Create predictive scenario", menu: "Main menu → Smart Predict → Create", detail: "Choose Time Series. Source: RetailCo_Sales_Analytic or exported dataset with Date + Revenue." },
      ...
      11: [
        ...
        },
        {
          ...
          steps: [
            ...
            { action: "Open Data Analyzer", menu: "Main menu → Data Analyzer", detail: "Explore RetailCo_Sales_Analytic ad-hoc. Export one pivot to Excel." },
      ...
      12: [
        {
          ...
          steps: [
            ...
            { action: "Open Connections", menu: "Main menu → Connections → Add", detail: "Look for Live → Datasphere (or SAP Datasphere). Trial may show connection types read-only — document menu path anyway." },
            { action: "Document connection fields", detail: "Host URL, authentication (OAuth / basic), space name — ask admin in real projects." },
            { action: "Create Live Model", menu: "Create → Model → Live data connection", detail: "Point to Datasphere analytic dataset. SAC stores metadata only — no row copy." },
            { action: "Build test story on live model", menu: "Create → Story", detail: "One KPI + bar chart. Compare load time vs import model." },
      ...
      14: [
        {
          ...
          steps: [
            ...
            { action: "Review sharing roles", menu: "Security → Roles / Teams", detail: "Viewer for executives, Explorer for analysts, Planner for Nandan on planning story." },
    ...
    TOPIC_EXAMPLES: {
      ...
      "3:3": "Nandan sends Excel with mixed date formats (15/03/2025 vs 2025-03-15). Data Wrangler normalises to ISO dates before import. Map Revenue as <strong>Decimal</strong>, Units as <strong>Integer</strong> — wrong types break totals.",
      ...
      "4:3": "Enable geo enrichment on Region dimension (location type: Region/State). Choropleth map: South dark green ₹2.1 Cr, Central lighter — Chinnu reads geography faster than a table.",
      ...
      "5:0": "Create → Story → Optimized Story → model <code>RetailCo_Sales_Analytic</code> → Canvas page. Builder = data slots. Styling = visuals only. Save as <code>RetailCo_Executive_Dashboard</code>.",
      ...
      "6:3": "Smart Insights on region bar: <em>\"East revenue down 8% — Snacks declined after competitor promo in Odisha.\"</em> Enable in widget Styling/Analytics section. Search to Insight: ask <em>\"Revenue by region last quarter\"</em>.",
    ...
    AI_PROMPTS: {
      ...
      3: [
        ...
        "Walk me through Create → Model → Get data from a file from file in SAC step by step. Include Data Wrangler, preview screen, and where to set Date vs Generic dimensions.",
      ...
      4: [
        ...
        "Walk me through geo enrichment on the Region dimension and building a choropleth map of India in SAC. What location type do I pick?",
      ...
      6: [
        ...
        "How do I enable Smart Insights and Search to Insight on RetailCo's revenue chart? What kind of explanation should I expect?",
    ...
    FLOW_CHARTS: {
      ...
      3: [
        {
          ...
          steps: [
            ...
            { label: "Data Wrangler", sub: "Clean dates & types" },
      ...
      4: [
        {
          ...
          steps: [
            ...
            { label: "Geo enrichment", sub: "Region → map" },
      ...
      6: [
        ...
        {
          title: "Smart Insights vs Search to Insight",
          type: "table",
          headers: ["", "Smart Insights", "Search to Insight"],
          rows: [
    ...
    TOPIC_TECHNICAL: {
      ...
      "3:3": "Import path: <strong>Create → Model → Get data from a file</strong> → upload CSV → <strong>Data Wrangler</strong> (transform) → map columns → preview row count → import. Prefer UTF-8 CSV; Excel also supported via Files.",
      ...
      "4:3": "Geo enrichment: Modeler → Region dimension → Location Information → enable enrichment, set location type (Region/Country). Required for Geo Map / choropleth widgets. Map member IDs must match enrichment dataset (South, North, etc.).",
      ...
      "5:0": "Create → Story → Optimized Story → select <code>RetailCo_Sales_Analytic</code>. Page type: <strong>Canvas</strong> (desktop). Panels: <strong>Builder</strong> (Rows/Columns/Measures) vs <strong>Styling</strong> (format, threshold). Widget insert via toolbar + icon menu.",
      ...
      "6:3": "Smart Insights: widget → enable in Builder/Analytics. Generates natural-language bullets from variance detection. Search to Insight: story search bar → NL query → temporary chart.",
      ...
      "7:0": "Planning = write-back to model. Home → Models → Start with blank model → <strong>Enable Planning</strong> (not Analytic). Requires import or acquired connection. Data Actions and version dimension unavailable in pure analytic models.",
      ...
      "10:0": "Smart Predict entry: Main menu → Smart Predict → Create scenario. Types: Classification · Regression · <strong>Time Series</strong>. Input: analytic model or imported dataset with Date + measure.",
